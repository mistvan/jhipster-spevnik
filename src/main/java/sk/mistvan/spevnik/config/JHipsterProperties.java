...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "spevnik@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "spevnik API";

        private String description = "spevnik API documentation";
