...
import sk.mistvan.spevnik.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("sk.mistvan.spevnik.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("sk.mistvan.spevnik.repository.search")
